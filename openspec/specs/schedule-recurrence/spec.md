# schedule-recurrence Specification

## Purpose
Defines the day-of-week recurrence cadence for schedules, including next-occurrence computation, DST handling, and the edit flow for both new and legacy schedules.
